U.extend(true, SaboteurOptions, {
  ...
  images : {
    ...
    DummyCard : {
      front_cover : 'images/cards/DummyCard-cover-front.png',
      back_cover  : 'images/Card-cover-back.png',
      icon        : 'images/cards/DummyCard-icon.png'
    },
    FreeAtLast : {
    ...
    GameCard : {
      front_cover : 'images/cards/GameCard-cover-front.png',
      back_cover  : 'images/Card-cover-back.png',
      icon        : 'images/cards/GameCard-icon.png'
    },
    GateCard : {
    ...
    MapCard : {
      front_cover : 'images/cards/MapCard-cover-front.png',
      back_cover  : 'images/Card-cover-back.png',
      icon        : 'images/cards/MapCard-icon.png'
    },
    MapClient : {
    ...
    Player : {
      front_cover : 'images/cards/Player-cover-front.png',
      back_cover  : 'images/Card-cover-back.png',
      icon        : 'images/cards/Player-icon.png'
    },
    PlayerActionCard : {
      front_cover : 'images/cards/PlayerActionCard-cover-front.png',
      back_cover  : 'images/Card-cover-back.png',
      icon        : 'images/cards/PlayerActionCard-icon.png'
    },
    PrivatePlayerActionCard : {
      front_cover : 'images/cards/PrivatePlayerActionCard-cover-front.png',
      back_cover  : 'images/Card-cover-back.png',
      icon        : 'images/cards/PrivatePlayerActionCard-icon.png'
    },
    Profiteer : {
    ...
    PublicPlayerActionCard : {
      front_cover : 'images/cards/PublicPlayerActionCard-cover-front.png',
      back_cover  : 'images/Card-cover-back.png',
      icon        : 'images/cards/PublicPlayerActionCard-icon.png'
    },
    RightCrystalCard : {
