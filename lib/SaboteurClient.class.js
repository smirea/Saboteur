  ...
  init    : (function(){
    return function( target, options, cards, classes ){
      ...
      var mapOptions = {
        ...
        startCards  : self.opt.startCards.map(function(v,i){ v.unshift(self.factory.get('start',i)); return v; }),
        goalCards   : self.opt.goalCards.map(function(v,i){ v.unshift(self.factory.get('goal',i)); return v; }),
      ...
      U.extend( true, this.cls, SaboteurOptions.classes, classes );
