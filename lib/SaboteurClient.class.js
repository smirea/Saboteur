...
var SaboteurClient = Saboteur.extend({
  init    : (function(){
    return function( target, options, cards, classes ){
      ...
      U.extend( true, this.com.cls, SaboteurOptions.classes, classes );
      
      var mapOptions = {
        startCards  : this.com.opt.startCards,
        goalCards   : this.com.opt.goalCards
      };
      console.log( mapOptions );
      preload_images.apply( this );
      create_structure.apply( this, [mapOptions] );
    };
    
    function create_structure( mapOptions ){
      this.com.structure = {
        wrapper : $(document.createElement('div')),
        map     : (new S.MapClient( mapOptions )).toElement(),
        players : $(),
    ...
    function preload_images(){
      var all_cards = {};
      U.extend( all_cards, this.com.gameDeckList, this.com.roleDeckList );
      var images = [];
